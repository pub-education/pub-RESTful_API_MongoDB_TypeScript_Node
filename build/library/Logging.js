...
const chalk_1 = __importDefault(require("chalk")); /* It's important to install chalk@^4.1.2 and not a later version since they only support ESM and not CommonJS */
...
Logging.warn = (args) => console.log(chalk_1.default.yellow(`[${new Date().toLocaleString()}] [WARNING]`), typeof args === "string" ? chalk_1.default.yellowBright(args) : args);
